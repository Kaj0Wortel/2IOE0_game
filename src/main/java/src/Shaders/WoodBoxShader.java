...
public class WoodBoxShader
        extends ShaderProgram {
    // Handy file paths.
    final private static String VERTEX = GS.SHADER_DIR + "wood_box_vertex.glsl";
    final private static String FRAGMENT = GS.SHADER_DIR + "wood_box_fragment.glsl";
    ...
    protected void getAllUniformLocations(GL3 gl) {
        ...
        textureLocation = getUniformLocation(gl, "boxTexture");
