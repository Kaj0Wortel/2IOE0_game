...
public class AStarPointersGlueFinal {
    ...
    */ // </editor-fold>
    ...
    public static void runAlgorithm() {
                    ...
                    */
                    ...
                    if (!alreadyInList) {
                        openlist.add(new NodeGlueFinal(sPos, sV, sA, sRot, sRotV,
                                sg, sh, sNextCP, curNode, ind, i + 1, j + 1));
                        // Debug succesor logs
                        if (iter == 0) {
        ...
        // TODO: Change location to your local file name (with complete path) when running.
        String location = "C:\\Users\\s165839\\Documents\\gitStuff\\2IOE0_game\\src\\main\\java\\src\\res\\A_star_data\\nodes.csv";
        try (NodeWriter nw = new NodeWriter(location)) {
